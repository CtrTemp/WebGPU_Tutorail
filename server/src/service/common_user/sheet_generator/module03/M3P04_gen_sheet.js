...
const gen_header = function () {
    ...
    const header_txt_list = ["O运营车站", "D运营车站", "时段", "OD量"];
...
const generate_page_styled_json_M3P04 = function (filtered_list, filter) {
...
module.exports = {
    generate_page_styled_json_M3P04
}
